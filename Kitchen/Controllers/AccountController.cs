...
namespace Kitchen.Controllers
{
    ...
    public partial class AccountController : Controller
    {
        ...
        {
            //KitchenMembershipProvider K = new KitchenMembershipProvider();
            if (ModelState.IsValid)
            {
                int id = KitchenMembershipProvider.ValidateUser(model.UserName, model.Password);
                if ( id > 0)
                {
        ...
        public virtual ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    //KitchenMembershipProvider K = new KitchenMembershipProvider();
                    //MembershipUser membershipUser = (K.CreateUser(model.EmailAddress, model.Password, model.Address, model.PhoneNumber, model.UserName));
                    WebSecurity.CreateUserAndAccount(model.UserName , model.Password,
                    new {EmailAddress = model.EmailAddress, Address = model.Address, PhoneNumber = model.PhoneNumber});
                    return RedirectToAction("Index", "Home");
                }
        ...
        //        {
        //            MembershipUser membershipUser = (K.CreateUser (model.EmailAddress, model.Password, model.Address, model.PhoneNumber, model.UserName));
        //            //WebSecurity.CreateUserAndAccount(model.UserName, model.Password, new { EmailAddress = model.EmailAddress, Address = model.Address, PhoneNumber = model.PhoneNumber });
