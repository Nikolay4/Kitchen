...
namespace T4MVC
{
    public class SharedController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Slider = "~/Views/Shared/Slider.cshtml";
            static readonly _AlbumsClass s_Albums = new _AlbumsClass();
            public _AlbumsClass Albums { get { return s_Albums; } }
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public partial class _AlbumsClass
            {
                static readonly _ViewNamesClass s_ViewNames = new _ViewNamesClass();
                public _ViewNamesClass ViewNames { get { return s_ViewNames; } }
                public class _ViewNamesClass
                {
                    public readonly string ListAlbums = "ListAlbums";
                }
                public readonly string ListAlbums = "~/Views/Shared/Albums/ListAlbums.cshtml";
            }
